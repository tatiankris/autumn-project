...
export const CardsTableBody = ({card}: PropsType) => {
    ...
    return (
        ...
        >
            <TableCell align="left" width={"39%"}>{card.questionImg
                ? <img src={card.questionImg} style={{height: '50px'}} alt=""/>
                : card.question}
            </TableCell>
            <TableCell align="left" width={"36%"}>{card.answerImg
                ? <img src={card.answerImg} style={{height: '50px'}} alt=""/>
                : card.answer}
            </TableCell>
